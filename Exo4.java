		...
		if (e.getSource() == btn1)        
		{
			...
			else
			{
				for (int i=0; i <tab.length;i++)
				{
					switch (tab[i])
					{
						case "premier"	: 	s+="Click sur le 1er  btn\n"; break;
						case "second"	: 	s+="Click sur le 2ème btn\n"; break;
						case "troisieme": 	s+="Click sur le 3ème btn\n"; break;
						case "quatrieme": 	s+="Click sur le 4ème btn\n"; break;
						case "cinquieme": 	s+="Click sur le 5ème btn\n"; break;
					}
				}
			}
